...
export class DataController {
  ...
  async priceBooks(@Req() request: { user: Principal }, @Query('includeRows') includeRows?: string, @Query('targetModule') targetModule?: PriceBookImportTargetModule) {
    if (includeRows === 'true') {
  ...
  @RequirePermission('pricing:price-books:sync-health-view')
  async pricingSyncHealth(@Req() request: { user: Principal }, @Query() query: { page?: number; pageSize?: number; legacyModule?: LegacyPricingModule | 'unclassified' }) {
